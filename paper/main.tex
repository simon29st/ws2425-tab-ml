...
- problem: usually conflicting objectives, i.e. minimisation of $\boldsymbol{c}$ along all dimensions not possible
...
- requires specifying trade-off between objectives a-priori
- simplest approach: different versions of \textbf{scalarization}
  * weighted sum of objective functions
    - $\min_{x\in\mathcal{X}} w_i f_i(x)$ with $\sum_{i=1}^k w_i=1$ and $w_i>0,\forall i=1,...,k$
    - \citep[p. 11]{10.1145/3610536}
  * Chebyshev: provably converges to Pareto front
