...
% TODO: after architectural details:
...
NI sums the numbers of all possible pairwise interactions in each group $\sum_g^G {p_g \choose 2}$ and divides them by the number of all possible pairwise interactions
