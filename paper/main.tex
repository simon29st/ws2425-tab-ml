...
- in many ways desirable, as per \citet[pp. 3-4]{Zach2019InterpretabilityOD}, e.g.
  ...
  * \textbf{regulatory}
    - such as EU's "Right to Explanation" warranted by the GDPR \citep[p. 1]{review_NN_interpretability} or
...
that in its regular feedforwad form is inherently non-interpretable.
% alternative
%As regular feedforward neural networks (NNs) are inherently non-interpretable models, the taxonomy introduced by \citet[chap. 2]{survey_NN_interpretability} proves
